...
/***/ function(module, exports, __webpack_require__) {
	...
	model.get('recipies[0].name').then(function (data) {
	  return console.log(data);
	});
	model.get(['recipies', 0, ['name', 'instructions']]).then(function (data) {
	  return console.log(data);
	});
	...
	model.get('recipies[0..99]["name", "instructions"]').then(function (data) {
	  return console.log(data);
	});
	...
	React.render(React.createElement(App, null), window.document.getElementById('target'));
